...
public class AvlSet<E extends Comparable<E>> extends BstSet<E>
    ...
    private AVLNode<E> removeRecursive(E element, AVLNode<E> n) {
        ...
        if (element.compareTo(n.element) < 0) {
            ...
            n.height = max(height(n.getLeft()), height(n.getRight())) + 1;
            int balance = getBalance(n);

            if (balance == 2 && getBalance(n.getLeft()) >= 0) {
            ...
            if (balance == -2 && getBalance(n.getRight()) <= 0) {
    ...
    private AVLNode<E> rightRotation(AVLNode<E> n2) {
        ...
        n1.setRight(n2);
        n2.height = max(height(n2.getLeft()), height(n2.getRight())) + 1;
        n1.height = max(height(n1.getLeft()), height(n2)) + 1;
        return n1;
    }
    ...
    private AVLNode<E> leftRotation(AVLNode<E> n1) {
        ...
        n2.setLeft(n1);
        n1.height = max(height(n1.getLeft()), height(n1.getRight())) + 1;
        n2.height = max(height(n2.getRight()), height(n1)) + 1;
        return n2;
    }
